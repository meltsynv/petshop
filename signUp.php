...
<div class="container">
    <form class="needs-validation" novalidate>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="email" class="form-control" id="validationCustom03" placeholder="E-Mail Adresse" required>
            <div class="invalid-feedback">
        ...
        <div class="col-md-3 mb-3">
            ...
            <input type="password" class="form-control" id="validationCustom04" placeholder="Passwort" required>
            <div class="invalid-feedback">
